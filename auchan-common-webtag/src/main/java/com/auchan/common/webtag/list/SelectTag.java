...
public class SelectTag extends ListControlTag implements Tag {
	...
	public int doStartTag() throws JspException {
		...
		CommonFacade commonFacade = ServiceUtil.getService("commonFacade", CommonFacade.class);
		metadata = commonFacade.getMetaDataList(mdgroup);
