...
public class FormatNumberTag extends FormatNumberSupport {
	...
	private void evaluateExpressions() throws JspException {
		...
		if (this.currencyCode_ != null) {
			this.currencyCode = ((String) ExpressionEvaluatorManager.evaluate("currencyCode", this.currencyCode_, String.class, this,
					this.pageContext));
		}

		if (this.currencySymbol_ != null) {
			this.currencySymbol = ((String) ExpressionEvaluatorManager.evaluate("currencySymbol", this.currencySymbol_, String.class, this,
					this.pageContext));
		}
		...
		if (this.groupingUsed_ != null) {
			...
			if (obj != null) {
				this.isGroupingUsed = ((Boolean) obj).booleanValue();
			}
		...
		if (this.maxIntegerDigits_ != null) {
			...
			if (obj != null) {
				this.maxIntegerDigits = ((Integer) obj).intValue();
			}
		...
		if (this.minIntegerDigits_ != null) {
			...
			if (obj != null) {
				this.minIntegerDigits = ((Integer) obj).intValue();
			}
		...
		if (this.maxFractionDigits_ != null) {
			...
			if (obj != null) {
				this.maxFractionDigits = ((Integer) obj).intValue();
			}
		...
		if (this.minFractionDigits_ != null) {
			...
			if (obj != null)
				this.minFractionDigits = ((Integer) obj).intValue();
		}
	}
}
