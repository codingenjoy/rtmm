...
<script type="text/javascript">
	function pageQuery() {
		...
		var responsePage = "commons/window/clusterInfoPageTwo";
		var clusterName = $('#clusterNameInput').val();
		var queryflag = true;
		if ($.trim(clusterName) == '' || $.trim(clusterName) == '输入系列名称查询') {
			queryflag = false;
		}
		if(!queryflag)
		{
