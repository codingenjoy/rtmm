...
<script src="${ctx}/shared/js/order/hoOrderDetail.js" type="text/javascript"></script>
...
$(function(){
	$("#resultListTag, .tags_close").unbind("click").bind("click",function(){
		backToImportList();
	});
	$("#hoOrderListTag").unbind("click").bind("click", function() {
		showContent("${ctx}/order/hoOrder");
	});
	$('.pro_store_tb_edit .ordItem:first').trigger("click");
});
...
function backToImportList(){
	...
	$('#importOrderDetail').html();
	$('#resultList').show();
	$("#hoOrderListTag, .tags_close").unbind("click").bind("click", function() {
		showContent("${ctx}/order/hoOrder");
	});
}
...
<div class="CInfo">
	<span>${ordBasicInfo.chngBy }</span> <span><auchan:i18n
			id="100002014" /> <!-- 修改人 --></span> <span><fmt:formatDate
			pattern="yyyy-MM-dd" value="${ordBasicInfo.chngDate }" /></span> <span><auchan:i18n
			id="100002015" /> <!-- 修改日期 --></span> <span>${ordBasicInfo.creatBy }</span>
	<span><auchan:i18n id="100002016" /> <!-- 建档人 --></span> <span><fmt:formatDate
			pattern="yyyy-MM-dd" value="${ordBasicInfo.creatDate }" /></span> <span><auchan:i18n
			id="100002017" /> <!-- 创建日期 --></span>
</div>
<div class="CM" style="height: 120px;">
		...
		<div class="CM-div">
			<div class="ig_top20">
				<div class="icol_text w14">
					<span><auchan:i18n id="104002005" /> <!-- 订单号码 --></span>
				</div>
			...
			<div class="ig">
				<div class="icol_text w14">
					<span><auchan:i18n id="104002006" /> <!-- 厂商 --></span>
				</div>
			...
			<div class="ig">
				<div class="icol_text w14">
					<span><auchan:i18n id="104002007" /> <!-- 课别 --></span>
				</div>
				<div class="iconPut w20 fl_left">
	...
	<div class="inner_half">
		<div class="CM-div">
			...
			<div class="ig">
				<div class="icol_text w14">
					<span><auchan:i18n id="104002009" /> <!-- 预订收货日 --></span>
				</div>
				<!--<input type="text" class="inputText w20 fl_left" />-->
			...
			<div class="ig">
				<div class="icol_text w14">
					<span><auchan:i18n id="104002010" /> <!-- 采购 --></span>
				</div>
				<input type="text" class="inputText w20 fl_left "
					value="${ordBasicInfo.buyerName }" readonly="readonly" />
				<span class="w12_5 fl_left">&nbsp;<auchan:i18n id="104002013" />
					<!-- 备注 --></span>
	...
	<div class="CM-div">
		<div class="pro_store_item">
			<div class="tb_tits">
				...
				<span class="pso2"> <auchan:i18n id="104002017" /> <!-- 销售单位 --> </span> 
			...
			<div class="pro_store_tb_edit">
				<c:forEach items="${OrditemInfo}" var="orderItem">
					<div class="ordItem"
						...
						<input type="text" readonly="readonly"
							title="${orderItem.itemName }" class="inputText w12 fl_left "
							value="${orderItem.itemName }" />
						<input type="text" readonly="readonly"
							class="inputText w10 fl_left " value="${orderItem.sellUnitTitle }" />
						<input type="text" readonly="readonly"
							class="inputText pedit_fth "
...
<div class="CM" style="height: 230px; margin-top: 2px;">
	...
	<div class="CM-div">
		<div class="pro_store_item">
			<div class="tb_tits">
				<span class="psi1"><auchan:i18n id="104002020" /> <!-- 分店 --></span><span
					class="psi2"><auchan:i18n id="104002021" /> <!-- 商品状态 --></span> <span
					class="psi3"><auchan:i18n id="104002022" /> <!-- 促销期数 --></span><span
					class="psi4"><auchan:i18n id="104002023" /> <!-- 订购数量 --></span> <span
					class="psi5"><auchan:i18n id="104002024" /> <!-- 赠品数量 --></span><span
					class="psi6"><auchan:i18n id="104002025" /> <!-- 买价(元) --></span>
				<span class="psi7"><auchan:i18n id="104002026" /> <!-- 订购倍数 --></span>
				<span class="psi8"><auchan:i18n id="104002027" /> <!-- 税率 --></span><span
					class="psi9"><auchan:i18n id="104002028" /> <!-- 净成本(元) --></span>
				<span class="psi10"><auchan:i18n id="104002029" /> <!-- 均销量 --></span><span
					class="psi11"><auchan:i18n id="104002030" /> <!-- 在途量 --></span> <span
					class="psi12"><auchan:i18n id="104002031" /> <!-- 库存量 --></span>
			</div>
