...
<script type="text/javascript">
	$(function() {
		...
		$(".pro_store_tb_edit").scroll(function() {
			var left = $(this).scrollLeft();
			$(".top_tempx").scrollLeft(left);
		});
...
.pro_store_items .bgColorRed{
	border:1px solid #f00;
}
.pro_store_items .item{
	/* width:auto; */
}
.trBgRed{
	background: #f00;
...
<div class="CTitle">
	...
	<!--一定不要忘了tag3-->
	<!--add-->
	<div class="tagsM_q  tagsM_on">创建新ART促销</div>
	<div class="tags3_close_on">
		<div class="tags_close" onclick="doCloseARTPage()"></div>
	</div>
</div>
