...
function toForecastPage(){
	$.ajax({
		url: ctx + '/promotion/DMManagement/forecast',
        type: "post",
        dataType:"html",
        success: function(data) {
        	DispOrHid('B-id');
 			$("#forecastContent").html(data);
 			$("#forecastContent").show(data);
 			$("#forecast").show();
 			$("#effectPeriodItem").hide();
 			$("#effectPeriodItemContent").hide();
        }
	});
}
</script>
...
<div class="CTitle" id="effectPeriodItem">
    <!--第一个-->
    <div class="tags1_left tags1_left_on"></div>
    <div class="tagsM tagsM_on" >DM期数与商品-按门店查询</div>
    <div class="tags tags_left_on"></div>
    <!--最后一个-->
    <div class="tagsM" onclick="toForecastPage()">海报商品预估量门店输入</div>
    <div class="tags tags3_r_off"></div>
</div>
 <div class="CTitle" id="forecast" >
     <!--第一个-->
     <div class="tags1_left"></div>
     <div class="tagsM ">DM期数与商品-按门店查询</div>
     <div class="tags tags_right_on"></div>
     <!--最后一个-->
     <div class="tagsM tagsM_on">海报商品预估量门店输入</div>
     <div class="tags tags3_r_on"></div>
 </div>
 <div class="Container-1" id="forecastContent" >
 </div>
<div class="Container-1" id="effectPeriodItemContent">
