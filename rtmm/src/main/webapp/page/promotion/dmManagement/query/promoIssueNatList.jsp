 ...
 <div class="htable_div">
                        <table>
                            ...
                            <tr>
                                ...
                                <td><div class="t_cols align_center" style="width:90px;">档期<!--<div style="display:inline-block;width:10px;height:20px;"></div>--></div></td>
                                ...
                                <td><div class="t_cols align_center" style="width:100px;">套系</div></td>
                                <td><div class="t_cols align_center" style="width:100px;">上档中</div></td>
 ...
 <!-- 
                        <table  class="single_tb w100">
                            <tr style="color:#ff6a00">
                                ...
                                <td style="width:91px;">123456</td>
                                <td style="width:291px;">世界杯</td>
                                <td style="width:101px;">XXXXX有限公司</td>
                                <td style="width:101px;">P&GXXXXX有限公司世界杯世界杯</td>
                                <td style="width:101px;">123456</td>
                                <td style="width:101px;">XXXXX有限公司</td>
                                <td style="width:101px;">123456</td>
                                <td style="width:101px;">上档中</td>
