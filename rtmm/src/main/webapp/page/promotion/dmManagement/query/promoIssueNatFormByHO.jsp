...
<script type="text/javascript">
	...
	/* 		$("#Tools22").attr('class', "Icon-size1 Tools22_on Tools22");
		$("#Tools21").attr('class', "Icon-size1 Tools21").bind("click",
			function() {
		}); */ 
...
<div class="CTitle">
	...
	<div class="tagsM tagsM_on" id="StoDMPerAndThemeTab">全国性DM期数与主题</div>
	<div class="tags tags_left_on"></div>
	<!--最后一个-->
	<div class="tagsM" id="NatAndStoDMPerAndThemeTab">全国性及门店DM期数与主题</div>
			...
			<div class="inner_half CM">
				...
				<div class="CM-div">
					...
					<div class="ig">
						...
						<input type="text" class="inputText w23" />
						&nbsp;
						<input type="text" class="inputText w40" />
					</div>
					<div class="ig">
