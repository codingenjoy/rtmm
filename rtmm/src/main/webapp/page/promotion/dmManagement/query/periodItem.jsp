...
<div class="CTitle">
     ...
     <div class="tagsM tagsM_on">DM期数与商品-按组别查询</div>
         ...
         <div class="htable_div">
             <table>
                 ...
                 <tr>
                     ...
                     <td><div class="t_cols" style="width:70px;">档期<!--<div style="display:inline-block;width:10px;height:20px;"></div>--></div></td>
                     <td><div class="t_cols" style="width:150px;">主题</div></td>
                     <td><div class="t_cols" style="width:80px;">代号类别</div></td>
                     <td><div class="t_cols" style="width:80px;">代号</div></td>
                     <td><div class="t_cols" style="width:80px;">促销提出方</div></td>
                     <td><div class="t_cols" style="width:80px;">参与组别</div></td>
                     <td><div class="t_cols" style="width:100px;">DM状态</div></td>
                     <td><div class="t_cols" style="width:70px;">组合促销</div></td>
                     <td><div class="t_cols" style="width:100px;">促销售价起始</div></td>
                     <td><div class="t_cols" style="width:100px;">促销售价结束</div></td>
