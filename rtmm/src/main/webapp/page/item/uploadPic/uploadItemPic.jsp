...
<link rel="stylesheet" type="text/css"
	href="${ctx}/shared/js/jquery-zwindow/css/default/zWindow.css" />
...
<script type="text/javascript">
	...
	$(function() {
		readItemPicInfos("${currentItemNo}");
	});
</script>
<div id="uploadPicInfo">
	...
	<div id="_photo">
		<div id="set_itemPic_p1" class="p1"></div>
	...
	<div id="update_p" class="_p">
		<div id="update_p_brower" class="p_brower"
