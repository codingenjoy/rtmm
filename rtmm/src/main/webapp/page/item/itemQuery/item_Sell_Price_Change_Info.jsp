...
<div class="jjxs_1">
	<span id="price1" class="item" style="margin-left: 0px;" onclick="setSearchTypeVal('buy');pageQuery();">进价信息</span>
	<span id="price2" class="item item_on" onclick="setSearchTypeVal('sell');pageQuery();">售价信息</span>
</div>
<div class="txm_info price1">
	<div class="txm_title">
		<span style="margin-left: 65px;">售价(元)</span>
	...
	<div class="price_tb">
		<c:forEach items="${priceChgList}" var="priceChg">
			<div class="ig">
				<input type="text" class="w20 inputText" value="${priceChg.sellPrice }" />
				...
				<div class="iconPut jxs">
					<input type="text" style="width: 79%" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${priceChg.spActiveDate}"/>" />
				</div>
			</div>
		</c:forEach>
	</div>
