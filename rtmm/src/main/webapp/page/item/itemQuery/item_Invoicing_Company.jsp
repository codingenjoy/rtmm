...
<div class="jxc_1">
	<div class="CM jxc_x">
		<span class="item store_invo" onclick="setSearchType('store');">门店进销存信息</span>
		<span class="item item_on" onclick="setSearchType('company');">全公司进销存信息</span>
	</div>
<div class="CM jxc_cm">
		<div class="CM-bar">
			<div>进货</div>
		...
		<div class="CM-div">
			<div class="tb50">
				<div class="ig">
					...
					<input type="text" class="inputText w15 fl_left" readonly="readonly" value="<fmt:formatNumber value="${itemStatVO.salesAmntTd }" pattern="#0.00"/>${itemStatVO.recptAmntTd}"/> 
				...
				<div class="ig">
					...
					<span class="sh_line25">&nbsp;件</span>
					<div class="msg_txt2">金额</div>
					<input type="text" class="inputText w15 fl_left" readonly="readonly" value="<fmt:formatNumber value="${itemStatVO.recptAmntCm }" pattern="#0.00"/>"/> 
					<span class="sh_line25">&nbsp;元</span>
				</div>
				<div class="ig">
					...
					<span class="sh_line25">&nbsp;件</span>
					<div class="msg_txt2">金额</div>
					<input type="text" class="inputText w15 fl_left" readonly="readonly" value="<fmt:formatNumber value="${itemStatVO.recptAmntCy}" pattern="#0.00"/>"/> 
					<span class="sh_line25">&nbsp;元</span>
				</div>
			</div>
			<div class="tb49">
		...
		<div class="CM-div">
			<div class="tb50">
				...
				<div class="ig">
					...
					<span class="sh_line25">&nbsp;元&nbsp;&nbsp;</span>
					<div class="msg_txt3">净毛利</div>
					<input type="text" class="inputText w15 fl_left" readonly="readonly" value="<fmt:formatNumber value="${itemStatVO.conForeCm }" pattern="#0.00"/>"/> 
					<span class="sh_line25">&nbsp;元</span>
				...
				<div class="ig">
					...
					<span class="sh_line25">&nbsp;元&nbsp;&nbsp;</span>
					<div class="msg_txt3">净毛利</div>
					<input type="text" class="inputText w15 fl_left" readonly="readonly" value="<fmt:formatNumber value="${itemStatVO.conForeCy }" pattern="#0.00"/>"/> 
					<span class="sh_line25">&nbsp;元</span>
				</div>
			</div>
			<div class="tb49">
