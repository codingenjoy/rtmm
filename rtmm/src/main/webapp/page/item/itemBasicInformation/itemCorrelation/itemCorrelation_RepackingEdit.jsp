	...
	<div class="CM-div">
		<div class="inner_half">
			...
			<div class="ig">
				...
				<input type="text" id="sonItemEnName" class="inputText w50 Black" readonly="readonly" />
			</div>
			<div class="ig">
				<div class="msg_txt">销售单位</div>
				<span class="jksp">1&nbsp;</span>
				<input class="inputText iq" id="sonSellUnit" type="text" style="width: 10%;" value="" readonly="readonly" /> 
				...
				<input class="inputText iq w10" id="sonBaseVol" type="text" value="" readonly="readonly" /> 
				<input class="inputText iq w10" id="sonBaseVolUnit" type="text" value="" readonly="readonly" />
			</div>
			<div class="ig">
				...
				<input type="text" id="sonCntdQty" maxlength="3" onkeyup="numberVerify(this)" class="w20 inputText"/>
			</div>
		</div>
		<div class="inner_half">
			<div class="ig" style="margin-top: 15px;">
