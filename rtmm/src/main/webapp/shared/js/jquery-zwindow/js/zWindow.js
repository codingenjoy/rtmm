	...
	*/
	$.zWindow.open = function(options){
		...
		function createContentMain(ZW){
			ZW.contentMain = $(models.contentMain)
												.height(setting.height-(ZW.titleBar?ZW.titleBar.height():0));
		...
		function resizeToMax_bak(ZW, jDom, eventSt){
			var d = {
				zw: ZW,
				dataKey: dataKey
			};
