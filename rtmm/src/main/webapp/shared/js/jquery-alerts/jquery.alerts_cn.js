...
//
// Usage:
//		jAlert( alertType, message, [title, callback] ),top.jAlert(alertType, 'ddd','����',function(){alert('���Իص�')})
//              alertType��4��ֵerror, success, warning, common
//		jConfirm( message, [title, callback] ),top.jConfirm('ddd','����',function(d){alert('���Իص�'+d)})
//		jPrompt( message, [value, title, callback] ),top.jConfirm('ddd','����',function(d){alert('���Իص�'+d)})
// 
// History:
//
...
(function($) {
	...
	$.alerts = {
		...
		alertButton: '确定',   // text for the alertbutton
