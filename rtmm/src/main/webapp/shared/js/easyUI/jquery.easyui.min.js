 ...
 * 
 * 修改tree 位于：1434 开始 修改datagrid 位于：datagrid-head 7311 7312 datagrid-body 8953
 * 8954 修改datagrid 位于7192 ，修改前检索的时候无法显示数据 修改pagination 位于：865 906 1000
 */
(function($) {
	$.parser = {
		auto : true,
...
(function($) {
	function _80(_81) {
		...
		var _84 = $(_81)
				.addClass("pagination")
				.html(
						"<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tr></tr></table>");// 这个table就是固定datagrid的上下翻页的table
		var tr = _84.find("tr");
		function _85(_86) {
			var btn = _83.nav[_86];
		...
		// $("<div
		// class=\"pagination-info\"></div>").appendTo(_84);//这个div就是固定显示一个页面有多少条数据的那部分
	...
	// beforePageText: "跳转到第", afterPageText: "{page}页", displayMsg: "第
	// {from}-{to} 项，共 {total} 项&nbsp;&nbsp;|&nbsp;&nbsp;每页显示", 3-1
	...
	function _fe(_ff, ul, data, _100) {
		...
		function _104(ul, _106, _107) {
			for (var i = 0; i < _106.length; i++) {
				...
				// $("<span
				// class=\"tree-title\"></span>").html(opts.formatter.call(_ff,
				// item)).appendTo(node);
				/*
				 * 为了把checkbox 和 file,folder 树Icon
				 * 的显示前后顺序调换**默认是Icon在checbox前面****
				 */
				...
				if (item.children && item.children.length) {
					...
					if (item.state == "open") {
						$(
								...
								.addClass(item.iconCls).appendTo(node);
...
(function($) {
	...
	function _4e0(_4e1, _4e2) {
		...
		;
		// var _4e6=$("<div class=\"datagrid-wrap\">"+"<div
		// class=\"datagrid-view\">"+"<div class=\"datagrid-view1\">"+"<div
		// class=\"datagrid-header\">"+"<div
		// class=\"datagrid-header-inner\"></div>"+"</div>"+"<div
		// class=\"datagrid-body\">"+"<div
		// class=\"datagrid-body-inner\"></div>"+"</div>"+"<div
		// class=\"datagrid-footer\">"+"<div
		// class=\"datagrid-footer-inner\"></div>"+"</div>"+"</div>"+"<div
		// class=\"datagrid-view2\">"+"<div class=\"datagrid-header\">"+"<div
		// class=\"datagrid-header-inner\"></div>"+"</div>"+"<div
		// class=\"datagrid-body\"></div>"+"<div
		// class=\"datagrid-footer\">"+"<div
		// class=\"datagrid-footer-inner\"></div>"+"</div>"+"</div>"+"</div>"+"</div>").insertAfter(_4e1);
		var _4e6 = $(
		...
		function _4f2(_4f7, _4f8, _4f9) {
			...
			for (var i = 0; i < _4f8.length; i++) {
				...
				for (var j = 0; j < cols.length; j++) {
					...
					var myx = "my-head-td-" + col.field;// my-head-td-productid
														// ...
														// 改变datagrid-head的列宽
														// 2-1
					var td = $("<td class=\"" + myx + "\" " + attr + "></td>")
							.appendTo(tr);// 这个td就是datagrid-header的列
											// 改变datagrid-head的列宽 2-2
					if (col.checkbox) {
		...
		renderRow : function(_66a, _66b, _66c, _66d, _66e) {
			...
			for (var i = 0; i < _66b.length; i++) {
				...
				if (col) {
					...
					// }
					cc.push("<td class=\"" + _670 + "\" field=\"" + _670
							+ "\" " + cls + " " + _674 + ">");
					if (col.checkbox) {
						var _674 = "";
					} else {
