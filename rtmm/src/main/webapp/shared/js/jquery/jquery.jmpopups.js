    ...
    function setPopupLayersPosition(popupElement, animate) {
        if (popupElement) {
            ...
            if (popupElement.height() < $(window).height()) {
                topPosition = document.documentElement.scrollTop|document.body.scrollTop + ($(window).height() - popupElement.height()) / 2;
            } else {
                topPosition = document.documentElement.scrollTop|document.body.scrollTop + 5;
            }
