...
//
// Usage:
//		jAlert( message, [title, callback] ),top.jAlert('ddd','≤‚ ‘',function(){alert('≤‚ ‘ªÿµ˜')})
//		jConfirm( message, [title, callback] ),top.jConfirm('ddd','≤‚ ‘',function(d){alert('≤‚ ‘ªÿµ˜'+d)})
//		jPrompt( message, [value, title, callback] ),top.jConfirm('ddd','≤‚ ‘',function(d){alert('≤‚ ‘ªÿµ˜'+d)})
// 
// History:
//
...
(function($) {
	...
	$.alerts = {
		...
		alert: function(message, title, callback, opts) {
		...
		_show: function(title, msg, value, type, callback, opts) {
			//add by wangliang
	...
	// Shortuct functions
	jAlert = function(message, title, callback, opts) {
		$.alerts.alert(message, title, callback, opts);
	};
